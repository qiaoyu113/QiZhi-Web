<template>
    <div id="navBar"
         v-bind:class="{'dingwei':this.$route.name=='home','backcolor1 bordbu1':this.$route.name=='home' && ticking==false}">
        <div class="nav_center">
            ...
            <div class="nav_ul">
                <router-link :to="{name:'home'}" v-bind:class="{'li_red':current1}">首页<span v-if="current1"
                                                                                            class="select_line"></span>
                </router-link>
                <router-link :to="{name:'news',params:{id:1}}" v-bind:class="{'li_red':current2}">资讯<span
                        v-if="current2" class="select_line"></span></router-link>
                <router-link :to="{name:'activity'}" v-bind:class="{'li_red':current3}">活动<span v-if="current3"
                                                                                                class="select_line"></span>
                </router-link>
                <router-link :to="{name:'concern'}" v-bind:class="{'li_red':current4}">关注<span v-if="current4"
                                                                                               class="select_line"></span>
                </router-link>
                <router-link :to="{name:'database'}" v-bind:class="{'li_red':current5}">资料库<span v-if="current5"
                                                                                                 class="select_line"></span>
                </router-link>
                <router-link :to="{name:'vip'}" v-bind:class="{'li_red':current6}">会员中心<span v-if="current6"
                                                                                             class="select_line"></span>
                </router-link>
            </div>
            ...
            <div class="tokenr clearfix">
                ...
                <div class="layer" v-if="loginFlag">
                    ...
                    <ul>
                        <li>
                            <router-link :to="{name:'purchase'}">个人中心</router-link>
                        </li>
                        ...
                        <li>
                            <router-link :to="{name:'setup'}">账号设置</router-link>
                        </li>
