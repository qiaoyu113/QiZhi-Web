           ...
           <!--文章信息-->
                    <div class="detail-container">
                        ...
                        <div class="article-look">
                            <span class="praise"><i class="iconfont icon-xianxingzan"></i>赞<span class="num">23</span></span>
                            <!-- <span class="praise"><i class="iconfont icon-xing"></i>赞<span class="num">23</span></span> -->
                            <span class="collection"><i class="iconfont icon-xianxingxing"></i>收藏<span class="num">1</span></span>
                            <!-- <span class="collection"><i class="iconfont icon-zan"></i>收藏<span class="num">1</span></span> -->
                            <span class="m-read"><i class="iconfont icon-shoujiyuedu" style="font-size:18px;"></i>手机阅读</span>
