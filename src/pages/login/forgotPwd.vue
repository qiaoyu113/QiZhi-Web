...
<script type="text/ecmascript-6">
  ...
  export default {
    props: [],
    components: {"phone": phone, 'kapt-sms': kaptSms, "pwd": pwd, 'login-close': loginClose  },
    data () {
    ...
    methods: {
      submit () { //表单提交的方法
        ...
        // 赋值区域 end
        mess = appService.formValidate(1, 1, 1, 1,{phoneNo: that.phoneNo, kaptchaValue: that.kaptchaValue, smsValue: that.smsValue, pwd: that.pwd});
